...
<head>
<title>ai_redis/redis.go · realwrtoff/ai_redis - 码云 Gitee.com</title>
...
<meta content='http://gitee.com/realwrtoff/ai_redis/blob/master/ai_redis/redis.go' property='og:url'>
<meta content='https://gitee.com/big_logo_gitee.jpg' itemprop='image' property='og:image'>
<meta content='ai_redis/redis.go · realwrtoff/ai_redis - 码云 Gitee.com' itemprop='name' property='og:title'>
...
<meta content="KHavGti9pxFu/WAcTZi6lvQRX3Nj2O0sqos2wZ7qqXQ=" name="csrf-token" />
...
<script>
  ...
  wx.config({
    ...
    timestamp: "1540867988",
    nonceStr: "298521ef7f8be82eaf3f035f05fc71d5",
    signature: "3cd191af8eb86675c2e448304fadc2eabd8f7e30",
    jsApiList: [
      'onMenuShareTimeline',
  ...
  wx.ready(function () {
    wx.onMenuShareTimeline({
      title: title, // 分享标题
      link: "https://gitee.com/realwrtoff/ai_redis/blob/master/ai_redis/redis.go", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
      imgUrl: imgUrl // 分享图标
    });
...
<input id="path" name="path" type="hidden" value="ai_redis/redis.go" />
...
<span class='file_name' title='redis.go'>
redis.go
</span>
<small>1.90 KB</small>
</div>
...
<a href="/realwrtoff" class="commit-author-link">realwrtoff</a>
<span>提交于</span>
<span class='timeago commit-date' title='2018-06-24 10:48:45 +0800'>
2018-06-24 10:48
</span>
.
<a href="/realwrtoff/ai_redis/commit/d46b2cb8d30191089f569dcf86fcec5716a85b11" title="添加默认的过期时间">添加默认的过期时间</a>
</span>
</div>
</div>
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a><a href='#L5' id='L5'>5</a><a href='#L6' id='L6'>6</a><a href='#L7' id='L7'>7</a><a href='#L8' id='L8'>8</a><a href='#L9' id='L9'>9</a><a href='#L10' id='L10'>10</a><a href='#L11' id='L11'>11</a><a href='#L12' id='L12'>12</a><a href='#L13' id='L13'>13</a><a href='#L14' id='L14'>14</a><a href='#L15' id='L15'>15</a><a href='#L16' id='L16'>16</a><a href='#L17' id='L17'>17</a><a href='#L18' id='L18'>18</a><a href='#L19' id='L19'>19</a><a href='#L20' id='L20'>20</a><a href='#L21' id='L21'>21</a><a href='#L22' id='L22'>22</a><a href='#L23' id='L23'>23</a><a href='#L24' id='L24'>24</a><a href='#L25' id='L25'>25</a><a href='#L26' id='L26'>26</a><a href='#L27' id='L27'>27</a><a href='#L28' id='L28'>28</a><a href='#L29' id='L29'>29</a><a href='#L30' id='L30'>30</a><a href='#L31' id='L31'>31</a><a href='#L32' id='L32'>32</a><a href='#L33' id='L33'>33</a><a href='#L34' id='L34'>34</a><a href='#L35' id='L35'>35</a><a href='#L36' id='L36'>36</a><a href='#L37' id='L37'>37</a><a href='#L38' id='L38'>38</a><a href='#L39' id='L39'>39</a><a href='#L40' id='L40'>40</a><a href='#L41' id='L41'>41</a><a href='#L42' id='L42'>42</a><a href='#L43' id='L43'>43</a><a href='#L44' id='L44'>44</a><a href='#L45' id='L45'>45</a><a href='#L46' id='L46'>46</a><a href='#L47' id='L47'>47</a><a href='#L48' id='L48'>48</a><a href='#L49' id='L49'>49</a><a href='#L50' id='L50'>50</a><a href='#L51' id='L51'>51</a><a href='#L52' id='L52'>52</a><a href='#L53' id='L53'>53</a><a href='#L54' id='L54'>54</a><a href='#L55' id='L55'>55</a><a href='#L56' id='L56'>56</a><a href='#L57' id='L57'>57</a><a href='#L58' id='L58'>58</a><a href='#L59' id='L59'>59</a><a href='#L60' id='L60'>60</a><a href='#L61' id='L61'>61</a><a href='#L62' id='L62'>62</a><a href='#L63' id='L63'>63</a><a href='#L64' id='L64'>64</a><a href='#L65' id='L65'>65</a><a href='#L66' id='L66'>66</a><a href='#L67' id='L67'>67</a><a href='#L68' id='L68'>68</a><a href='#L69' id='L69'>69</a><a href='#L70' id='L70'>70</a><a href='#L71' id='L71'>71</a><a href='#L72' id='L72'>72</a><a href='#L73' id='L73'>73</a><a href='#L74' id='L74'>74</a><a href='#L75' id='L75'>75</a><a href='#L76' id='L76'>76</a><a href='#L77' id='L77'>77</a><a href='#L78' id='L78'>78</a><a href='#L79' id='L79'>79</a><a href='#L80' id='L80'>80</a><a href='#L81' id='L81'>81</a><a href='#L82' id='L82'>82</a><a href='#L83' id='L83'>83</a><a href='#L84' id='L84'>84</a><a href='#L85' id='L85'>85</a><a href='#L86' id='L86'>86</a><a href='#L87' id='L87'>87</a><a href='#L88' id='L88'>88</a><a href='#L89' id='L89'>89</a><a href='#L90' id='L90'>90</a><a href='#L91' id='L91'>91</a><a href='#L92' id='L92'>92</a><a href='#L93' id='L93'>93</a><a href='#L94' id='L94'>94</a><a href='#L95' id='L95'>95</a><a href='#L96' id='L96'>96</a></div><div class='highlight'><pre><div class='line' id='LC1'><span class="k">package</span><span class="x"> </span><span class="n">ai_redis</span>&#x000A;</div><div class='line' id='LC2'>&#x000A;</div><div class='line' id='LC3'><span class="k">import</span><span class="x"> </span><span class="p">(</span>&#x000A;</div><div class='line' id='LC4'><span class="x">	</span><span class="s">"fmt"</span>&#x000A;</div><div class='line' id='LC5'><span class="x">	</span><span class="s">"github.com/go-redis/redis"</span>&#x000A;</div><div class='line' id='LC6'><span class="x">	</span><span class="s">"time"</span>&#x000A;</div><div class='line' id='LC7'><span class="p">)</span>&#x000A;</div><div class='line' id='LC8'>&#x000A;</div><div class='line' id='LC9'><span class="k">type</span><span class="x"> </span><span class="n">AIRedis</span><span class="x"> </span><span class="k">struct</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC10'><span class="x">	</span><span class="n">Host</span><span class="x"> </span><span class="kt">string</span>&#x000A;</div><div class='line' id='LC11'><span class="x">	</span><span class="n">Port</span><span class="x"> </span><span class="kt">int</span>&#x000A;</div><div class='line' id='LC12'><span class="x">	</span><span class="n">Password</span><span class="x"> </span><span class="kt">string</span>&#x000A;</div><div class='line' id='LC13'><span class="x">	</span><span class="n">Db</span><span class="x"> </span><span class="kt">int</span>&#x000A;</div><div class='line' id='LC14'><span class="x">	</span><span class="n">Cli</span><span class="x"> </span><span class="o">*</span><span class="n">redis</span><span class="o">.</span><span class="n">Client</span>&#x000A;</div><div class='line' id='LC15'><span class="x">	</span><span class="n">ExpireTime</span><span class="x"> </span><span class="kt">int64</span>&#x000A;</div><div class='line' id='LC16'><span class="p">}</span>&#x000A;</div><div class='line' id='LC17'>&#x000A;</div><div class='line' id='LC18'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">Init</span><span class="p">(</span><span class="n">host</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">port</span><span class="x"> </span><span class="kt">int</span><span class="p">,</span><span class="x"> </span><span class="n">password</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">db</span><span class="x"> </span><span class="kt">int</span><span class="p">,</span><span class="x"> </span><span class="n">expireTime</span><span class="x"> </span><span class="kt">int64</span><span class="p">)</span><span class="x"> </span><span class="kt">error</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC19'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">Host</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">host</span>&#x000A;</div><div class='line' id='LC20'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">Port</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">port</span>&#x000A;</div><div class='line' id='LC21'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">Password</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">password</span>&#x000A;</div><div class='line' id='LC22'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">Db</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">db</span>&#x000A;</div><div class='line' id='LC23'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">ExpireTime</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">expireTime</span>&#x000A;</div><div class='line' id='LC24'><span class="x">	</span><span class="n">address</span><span class="x"> </span><span class="o">:=</span><span class="x"> </span><span class="n">fmt</span><span class="o">.</span><span class="n">Sprintf</span><span class="p">(</span><span class="s">"%s:%d"</span><span class="p">,</span><span class="x"> </span><span class="n">host</span><span class="p">,</span><span class="x"> </span><span class="n">port</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC25'><span class="x">	</span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">redis</span><span class="o">.</span><span class="n">NewClient</span><span class="p">(</span><span class="o">&amp;</span><span class="n">redis</span><span class="o">.</span><span class="n">Options</span><span class="p">{</span>&#x000A;</div><div class='line' id='LC26'><span class="x">		</span><span class="n">Addr</span><span class="o">:</span><span class="x"> </span><span class="n">address</span><span class="p">,</span>&#x000A;</div><div class='line' id='LC27'><span class="x">		</span><span class="n">Password</span><span class="o">:</span><span class="x"> </span><span class="n">password</span><span class="p">,</span>&#x000A;</div><div class='line' id='LC28'><span class="x">		</span><span class="n">DB</span><span class="o">:</span><span class="x"> </span><span class="n">db</span><span class="p">,</span>&#x000A;</div><div class='line' id='LC29'><span class="x">	</span><span class="p">})</span>&#x000A;</div><div class='line' id='LC30'><span class="x">	</span><span class="n">_</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">:=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">Ping</span><span class="p">()</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC31'><span class="x">	</span><span class="k">return</span><span class="x"> </span><span class="n">err</span>&#x000A;</div><div class='line' id='LC32'><span class="p">}</span>&#x000A;</div><div class='line' id='LC33'>&#x000A;</div><div class='line' id='LC34'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">Set</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">expireTime</span><span class="x"> </span><span class="kt">int64</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">str</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC35'><span class="x">	</span><span class="n">str</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">Set</span><span class="p">(</span><span class="n">key</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="p">,</span><span class="x"> </span><span class="n">time</span><span class="o">.</span><span class="n">Duration</span><span class="p">(</span><span class="n">expireTime</span><span class="p">)</span><span class="o">*</span><span class="n">time</span><span class="o">.</span><span class="n">Second</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC36'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">!=</span><span class="x"> </span><span class="no">nil</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC37'><span class="x">		</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC38'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC39'><span class="x">	</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC40'><span class="p">}</span>&#x000A;</div><div class='line' id='LC41'>&#x000A;</div><div class='line' id='LC42'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">Delete</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">)</span><span class="x"> </span><span class="kt">error</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC43'><span class="x">	</span><span class="k">return</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">Del</span><span class="p">(</span><span class="n">key</span><span class="p">)</span><span class="o">.</span><span class="n">Err</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC44'><span class="p">}</span>&#x000A;</div><div class='line' id='LC45'>&#x000A;</div><div class='line' id='LC46'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">Rpush</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="x"> </span><span class="kt">string</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">n</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC47'><span class="x">	</span><span class="k">var</span><span class="x"> </span><span class="n">v</span><span class="x"> </span><span class="k">interface</span><span class="p">{}</span>&#x000A;</div><div class='line' id='LC48'><span class="x">	</span><span class="n">v</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">RPush</span><span class="p">(</span><span class="n">key</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC49'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">!=</span><span class="x"> </span><span class="no">nil</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC50'><span class="x">		</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC51'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC52'><span class="x">	</span><span class="n">n</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">v</span><span class="o">.</span><span class="p">(</span><span class="kt">int64</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC53'><span class="x">	</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC54'><span class="p">}</span>&#x000A;</div><div class='line' id='LC55'>&#x000A;</div><div class='line' id='LC56'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">Lpop</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">str</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC57'><span class="x">	</span><span class="k">var</span><span class="x"> </span><span class="n">v</span><span class="x"> </span><span class="k">interface</span><span class="p">{}</span>&#x000A;</div><div class='line' id='LC58'><span class="x">	</span><span class="n">v</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">LPop</span><span class="p">(</span><span class="n">key</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC59'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">!=</span><span class="x"> </span><span class="no">nil</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC60'><span class="x">		</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC61'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC62'><span class="x">	</span><span class="n">str</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">v</span><span class="o">.</span><span class="p">(</span><span class="kt">string</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC63'><span class="x">	</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC64'><span class="p">}</span>&#x000A;</div><div class='line' id='LC65'>&#x000A;</div><div class='line' id='LC66'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">LLen</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">n</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC67'><span class="x">	</span><span class="k">var</span><span class="x"> </span><span class="n">v</span><span class="x"> </span><span class="k">interface</span><span class="p">{}</span>&#x000A;</div><div class='line' id='LC68'><span class="x">	</span><span class="n">v</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">LLen</span><span class="p">(</span><span class="n">key</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC69'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">!=</span><span class="x"> </span><span class="no">nil</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC70'><span class="x">		</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC71'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC72'><span class="x">	</span><span class="n">n</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">v</span><span class="o">.</span><span class="p">(</span><span class="kt">int64</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC73'><span class="x">	</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC74'><span class="p">}</span>&#x000A;</div><div class='line' id='LC75'>&#x000A;</div><div class='line' id='LC76'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">SetNX</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">expireTime</span><span class="x"> </span><span class="kt">int64</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">n</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC77'><span class="x">	</span><span class="k">var</span><span class="x"> </span><span class="n">ok</span><span class="x"> </span><span class="kt">bool</span>&#x000A;</div><div class='line' id='LC78'><span class="x">	</span><span class="n">ok</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">SetNX</span><span class="p">(</span><span class="n">key</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="p">,</span><span class="x"> </span><span class="n">time</span><span class="o">.</span><span class="n">Duration</span><span class="p">(</span><span class="n">expireTime</span><span class="p">)</span><span class="o">*</span><span class="n">time</span><span class="o">.</span><span class="n">Second</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC79'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="o">!=</span><span class="x"> </span><span class="no">nil</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC80'><span class="x">		</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC81'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC82'><span class="x">	</span><span class="k">if</span><span class="x"> </span><span class="n">ok</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC83'><span class="x">		</span><span class="n">n</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="m">1</span>&#x000A;</div><div class='line' id='LC84'><span class="x">	</span><span class="p">}</span><span class="x"> </span><span class="k">else</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC85'><span class="x">		</span><span class="n">n</span><span class="x"> </span><span class="o">=</span><span class="x"> </span><span class="o">-</span><span class="m">1</span>&#x000A;</div><div class='line' id='LC86'><span class="x">	</span><span class="p">}</span>&#x000A;</div><div class='line' id='LC87'><span class="x">	</span><span class="k">return</span>&#x000A;</div><div class='line' id='LC88'><span class="p">}</span>&#x000A;</div><div class='line' id='LC89'>&#x000A;</div><div class='line' id='LC90'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">SetBit</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">offset</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="x"> </span><span class="kt">int</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">n</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC91'><span class="x">	</span><span class="k">return</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">SetBit</span><span class="p">(</span><span class="n">key</span><span class="p">,</span><span class="x"> </span><span class="n">offset</span><span class="p">,</span><span class="x"> </span><span class="n">value</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC92'><span class="p">}</span>&#x000A;</div><div class='line' id='LC93'>&#x000A;</div><div class='line' id='LC94'><span class="k">func</span><span class="x"> </span><span class="p">(</span><span class="n">rds</span><span class="x"> </span><span class="o">*</span><span class="n">AIRedis</span><span class="p">)</span><span class="n">GetBit</span><span class="p">(</span><span class="n">key</span><span class="x"> </span><span class="kt">string</span><span class="p">,</span><span class="x"> </span><span class="n">offset</span><span class="x"> </span><span class="kt">int64</span><span class="p">)</span><span class="x"> </span><span class="p">(</span><span class="n">n</span><span class="x"> </span><span class="kt">int64</span><span class="p">,</span><span class="x"> </span><span class="n">err</span><span class="x"> </span><span class="kt">error</span><span class="p">)</span><span class="x"> </span><span class="p">{</span>&#x000A;</div><div class='line' id='LC95'><span class="x">	</span><span class="k">return</span><span class="x"> </span><span class="n">rds</span><span class="o">.</span><span class="n">Cli</span><span class="o">.</span><span class="n">GetBit</span><span class="p">(</span><span class="n">key</span><span class="p">,</span><span class="x"> </span><span class="n">offset</span><span class="p">)</span><span class="o">.</span><span class="n">Result</span><span class="p">()</span>&#x000A;</div><div class='line' id='LC96'><span class="p">}</span>&#x000A;</div></pre></div></div>
</div>
...
<input id="comment_path" name="comment_path" type="hidden" value="ai_redis/redis.go" />
